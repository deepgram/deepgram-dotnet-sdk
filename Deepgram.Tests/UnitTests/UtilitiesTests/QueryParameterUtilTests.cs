...
public class QueryParameterUtilTests
{
    ...
    public void GetParameters_Should_Return_String_When_Passing_String_Parameter()
    {
        ...
        //Act
        var result = QueryParameterUtil.GetParameters(nameof(ConcreteRestClient), prerecordedOptions);
    ...
    public void GetParameters_Should_Return_String_When_Passing_Int_Parameter()
    {
        ...
        //Act
        var result = QueryParameterUtil.GetParameters(nameof(ConcreteRestClient), obj);
    ...
    public void GetParameters_Should_Return_String_When_Passing_DateTime_Parameter()
    {
        ...
        //Act
        var result = QueryParameterUtil.GetParameters(nameof(ConcreteRestClient), option);
    ...
    {
        //Act
        var result = QueryParameterUtil.GetParameters(nameof(ConcreteRestClient), new PrerecordedSchema());
